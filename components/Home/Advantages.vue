    ...
    <div class="container">
      <div class="advantages__item" v-for="(item, index) in items">
        ...
        <div class="advantages__content">
          <div class="advantages__text p" v-html="item.text"></div>
          ...
          <div class="advantages__btn">
            <nuxt-link class="btn" :class="globalStore < 768 ? 'btn-red':''" to="/quiz">START MY FREE TELE-VISIT</nuxt-link>
          </div>
        </div>
      </div>
    </div>
...
const items: Array<ItemType> = [
  ...
  },
  {
    ...
    text: `You'll be connected with a qualified medical professional who can assist with finding you the best way to treat your toenail fungus. <br><br>You can send messages directly to your doctor to help ensure all your needs are being met.`,
    img: 'adv-02'
  },
  {
